...
void sort_pairs(void)
{
    ...
    {
        int win_ind = pairs[i].winner;
        int los_ind = pairs[i].loser;

        strength[i] = preferences[win_ind][los_ind] - preferences[los_ind][win_ind];
    }
